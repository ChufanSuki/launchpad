# Copyright 2023 Chufan Chen. All rights reserved.
#
...
from launchpad.launch.run_distribute import run_distribute
...
def launch(program: lp_program.Program,
  ...
  """Launches a program using ssh across multiple machines."""
  ...
  return run_distribute.run_commands_distribute(commands, terminal)
